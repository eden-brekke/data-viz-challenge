...
export default function Footer({ cite }) {
  return (
    <>
      <div id='footer'>
        <a className="dev-link" href="http://github.com/eden-brekke">Developed By Eden</a>
        <div className="citation-info">
          ...
          <div className="cite-links">
            <p>Available from <a className="footer-link" href="http://ghdx.healthdata.org/gbd-results-tool.">GBD Results Tool</a>
              Permalink to <a className="footer-link" href="http://ghdx.healthdata.org/gbd-results-tool?params=gbd-api-2017-permalink/c12b65baf872c661f4640bb583320b4e">Opioid use Disorder data</a></p>
          </div>
        </div>
      </div>
    </>
