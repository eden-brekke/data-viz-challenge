  ...
  if (data[0] === "Loading") {
    ...
    return (
      <>
        ...
        <p>The purpose of this graph set is to look at the comparison between biological sex populations. Though looking at the combined data does show interesting trends in certain comparison contexts.<br></br>If you click through a couple of different locations and generate those graphs, you'll notice a pretty overwhelming trend.<br></br> That trend is that male populations are much more likely to succumb to opioid use disorder.<br></br>It's difficult to speculate the cause behind this, as there are many factors that play a role in our society. However, the data does not lie, regardless of the reason behind it, the male population is affected more by opioid use disorder.</p>
        </div>
      </>
    );
  }
